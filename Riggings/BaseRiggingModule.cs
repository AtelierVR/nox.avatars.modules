...
namespace Nox.CCK.Avatars.Rigging {
	public abstract class BaseRiggingModule : MonoBehaviour, IRiggingModule, IParameterGroup {
		...
		/// <summary>
		/// The id of the backend that instantiated this module (e.g. "rigbuilder", "finalik").
		/// Assigned by <see cref="IRiggingBackend.Instantiate"/> and used by
		/// <see cref="RiggingSetupModule"/> to detect remote backend mismatches.
		/// </summary>
		...
		/// <summary>
		/// Destroys any generated IK target GameObjects owned by this module (the
		/// <see cref="RiggingPart"/> transforms). Called before hot-swapping backends so
		/// stale VRIK_*/IKRig_* targets do not linger on the anchor.
		/// </summary>
